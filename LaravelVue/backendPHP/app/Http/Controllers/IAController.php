...
class IAController extends Controller
{
    private function askChatGPT($pergunta)
    {
        ...
        try {
            // Fazendo a requisição para o modelo correto
            $response = $client->post('https://api.openai.com/v1/chat/completions', [
                ...
                'json' => [
                    'model' => 'gpt-3.5-turbo',  // Use "gpt-3.5-turbo" se não tiver acesso ao "gpt-4-turbo"
                    'messages' => [
                        ['role' => 'user', 'content' => $pergunta],  // Define a pergunta do usuário
                    ],
                    'max_tokens' => 150,
                    'temperature' => 0.7,
                ],
